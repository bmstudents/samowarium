...
CAN_NOT_RELOGIN_CHANGE_PASSOWRD_PROMPT = "Получено сообщение от почтового сервера. Необходимо сменить пароль. Работа бота приостановлена. Для продолжения работы смените пароль (https://student.bmstu.ru) и заново авторизуйтесь\n/login _логин_ _пароль_"
